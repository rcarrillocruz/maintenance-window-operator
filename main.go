...
func init() {
	...
	utilruntime.Must(windowv1alpha1.AddToScheme(scheme))
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "4ab7b399.open-cluster-management.io",
	})
	if err != nil {
	...
	if err = (&windowv1alpha1.MaintenanceWindow{}).SetupWebhookWithManager(mgr); err != nil {
